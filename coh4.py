...
def func_separa_palavras(frasesAux):
    ...
    return (palavrasAux, qtd)


""" def func_qtd_de_palavras(palavrasAux):
...
def func_tamanho_medio_palavra(palavrasAux, qtd):
...
def main():
    ...
    # func_qtd_de_palavras(separaFrases)
    func_tamanho_medio_palavra(separaPalavras, qtd1)
